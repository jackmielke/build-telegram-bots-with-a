          ...
          <>
            ...
            <div className="space-y-6 py-4">
              <div className="bg-muted/50 p-6 rounded-lg space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-medium mb-1">Open BotFather on Telegram</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-medium mb-1">Create a new bot</p>
                    <p className="text-sm text-muted-foreground">
                      Send <code className="px-1 py-0.5 bg-muted rounded text-xs">/newbot</code> and follow the prompts to set your bot's name and username
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-medium mb-1">Customize your bot (optional)</p>
                    <p className="text-sm text-muted-foreground">
                      Use <code className="px-1 py-0.5 bg-muted rounded text-xs">/setdescription</code> and <code className="px-1 py-0.5 bg-muted rounded text-xs">/setuserpic</code> to add a description and profile photo
                    </p>
                  </div>
                </div>
              ...
              <div className="flex justify-end">
                <Button onClick={() => setStep('token')} className="gradient-primary">
                  I've Created My Bot
