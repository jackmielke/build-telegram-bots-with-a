  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const {
        ...
        universal_id: '' // Will be auto-generated by trigger if configured
      }]).select().single();
        ...
        <form onSubmit={handleCreate}>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Input id="name" placeholder="e.g., Crypto Enthusiasts" value={name} onChange={e => setName(e.target.value)} disabled={loading} maxLength={100} />
            </div>
